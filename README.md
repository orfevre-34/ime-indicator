...
[![ci](https://github.com/orfevre-34/ime-indicator/actions/workflows/ci.yml/badge.svg)](https://github.com/orfevre-34/ime-indicator/actions/workflows/ci.yml)
[![release](https://github.com/orfevre-34/ime-indicator/actions/workflows/release.yml/badge.svg)](https://github.com/orfevre-34/ime-indicator/actions/workflows/release.yml)
...
[Releases ページ](https://github.com/orfevre-34/ime-indicator/releases) から
最新の `IMEIndicator-Setup.exe` をダウンロードしてダブルクリック。
インストール時に「Windows ログオン時に自動起動する」のチェックを付けると登録される（あとでトレイメニューからも切替可）。

自分でビルドしたい場合は [インストーラのビルド手順](installer/README.md) を参照。
...
uv run tools/gen_icon.py   # アイコン .ico を再生成（Pillow を uv の隔離環境に自動取得）
```
